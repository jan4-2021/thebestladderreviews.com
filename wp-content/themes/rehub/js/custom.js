...
jQuery(document).ready(function($) {
   ...
   $('.re_tax_dropdown').on('click', '.label', function(e) {
    ...
    if( $('.sidebar .widget-meta-data-filter').length > 0 ){
        ...
        $(".main-side").prepend('<span class="mobile_mdtf_toggle_btn desktopdisplaynone wpsm-button white medium mb25"><i class="fa fa-bars"></i> '+ filtertitle + '</span>');
    ...
    if( $('.sidebar .widget_price_filter').length > 0 ){
        ...
        $(".main-side").prepend('<span class="mobile_woo_filter_toggle_btn desktopdisplaynone wpsm-button white medium mb25"><i class="fa fa-bars"></i> '+ filtertitle + '</span>');
    ...
    if($('.custom-html-widget .wpf_form').length > 0){
        ...
        if(filtertitle){
            $(".main-side").prepend('<span class="mobile_wpf_toggle_btn wpsm-button desktopdisplaynone white medium mb25"><i class="fa fa-bars"></i> '+ filtertitle + '</span>');           
...
jQuery(window).on('load', function(){
   ...
   if(jQuery().flexslider) {
      ...
      jQuery('.gallery_top_slider').each(function() {
         ...
         tag.src = "//web.archive.org/web/20180906051436/https://www.youtube.com/iframe_api";
...
/*
     FILE ARCHIVED ON 05:14:36 Sep 06, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 14:49:48 Jan 04, 2021.
...
playback timings (ms):
  ...
  RedisCDXSource: 38.071
  captures_list: 564.524
  load_resource: 284.865
  PetaboxLoader3.datanode: 563.261 (4)
  LoadShardBlock: 495.868 (3)
  exclusion.robots: 0.481
  esindex: 0.028
  PetaboxLoader3.resolve: 110.418
*/